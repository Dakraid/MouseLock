...
Changelog:
    > 1.2.4: Reduced delay for accuracy and added a buffer zone for the borders
    > 1.2.3: Added an icon for the application
    > 1.2.2: Added a timeout delay to reduce the CPU intensity of the application